                    ...
                    @for ($i = 0; $i < 4; $i++)
                        <div class=" overflow-hidden shadow-sm rounded-lg border dark:border-zinc-600">
                            <div class="p-5">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium textaccent dark:text-gray-400 truncate">
                                                Kondisi Tanah</dt>
                                            <dd class="text-lg font-semibold text-gray-900 dark:text-white">Nilai</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-gray-50 dark:bg-zinc-700 px-5 py-3">
                                <div class="text-sm">
                                    <a href="#" class="font-medium text-green-600 hover:text-accent">Lihat semua</a>
                                </div>
                            </div>
                        </div>
                    @endfor
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-5">
                            <div class="flex justify-between items-center">
                                <div class="text-sm font-medium textaccent dark:text-gray-400">Total Pengguna</div>
