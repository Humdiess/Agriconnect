...
<div class="min-h-screen bg-ireng/30 dark:bg-ireng flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
    <div
        ...
        <div class="flex justify-between items-center">
            <a href="{{ route('home') }}"
                class="flex items-center justify-center w-10 h-10 bg-accent text-white rounded-full hover:bg-accent/80 transition-colors duration-200"
        ...
        <form action="#" method="POST" class="mt-4 space-y-6">
            ...
            <div>
                <label for="phone_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nomor
                    Handphone (Diawali 62) ,<br><span class="opacity-90 text-xs">Contoh : 6281220594204</span></label>
                <input id="phone_number" name="phone_number" type="tel" required
                    ...
                    placeholder="628123456789" value="{{ old('phone_number') }}" aria-describedby="phone-description">
                @error('phone_number')
            ...
            <div class="flex items-center">
                <input id="valid" name="valid" type="checkbox" required
                    class="h-4 w-4 text-accent focus:ring-accent border-gray-300 rounded dark:border-gray-600 dark:bg-zinc-700">
            ...
            <div>
                <button type="submit"
                    class="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-accent hover:bg-accent/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent transition-colors duration-200">Daftar
                    Sekarang</button>
            </div>
        </form>
    </div>
