...
<x-navbar />
            ...
            <div class="shop-hero w-100 flex flex-col items-center justify-center mx-8">
                <div class="shop-hero-title text-center">
                    <h1 class="text-3xl text-center leading-9 font-bold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                        ...
                        <span class="block text-accent max-w-[46rem] text-center">Produk Berkualitas untuk Pertanian Tebu</span>
                    </h1>
        ...
        <div class="shop-content-wrapper w-full">
            <div class="shop-content w-full">
                ...
                <div class="filter-sort flex justify-between items-center mb-8">
                    <div class="filter">
                        <select class="bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-accent focus:border-accent block w-full p-2.5">
                ...
                <div class="product-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    @for ($i = 1; $i <= 8; $i++)
                        <div class="product-card bg-white dark:bg-zinc-800 rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl">
                ...
                <div class="pagination flex justify-center mt-12">
                    <nav class="inline-flex rounded-md shadow">
                        <a href="#" class="px-4 py-2 rounded-l-md border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-700">Previous</a>
                        <a href="#" class="px-4 py-2 border-t border-b border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-700">1</a>
                        <a href="#" class="px-4 py-2 border-t border-b border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-700">2</a>
                        <a href="#" class="px-4 py-2 border-t border-b border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-700">3</a>
                        <a href="#" class="px-4 py-2 rounded-r-md border border-gray-300 dark:border-zinc-600 bg-white dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-zinc-700">Next</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <section class="newsletter-container container mx-auto px-8 md:px-16 py-16">
        <div class="newsletter-wrapper w-full bg-white dark:bg-zinc-800 rounded-lg shadow-lg p-8">
