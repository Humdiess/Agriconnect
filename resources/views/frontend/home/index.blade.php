...
<section class="hero-container container mx-auto relative">
    <!-- Aurora Effects -->
    ...
    <div class="hero-wrapper w-full relative z-10">
        <div class="hero w-100 flex flex-col items-center justify-center">
            ...
            <a href="#" class="hero-button mt-6 px-6 py-2 bg-[#5DBB63] text-white mb-0 rounded-full font-light">Pelajari lebih lanjut</a>
        </div>
...
<section class="about-us-container bg-[#5DBB63] py-12 flex justify-center items-center">
    ...
    <div class="features-wrapper">
        <div class="features flex justify-center">
            <div class="features-header py-12">
                <h1 class="text-xl font-semibold">Fitur Kami</h1>
            </div>
        </div>
    </div>
</section>
