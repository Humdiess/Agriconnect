    ...
    @auth
        ...
        <div class="relative">
            <button id="user-dropdown"
                class="bg-[#5DBB63] px-8 py-[0.8rem] text-white text-sm rounded-lg flex items-center justify-between">
                {{ Auth::user()->name }}
    ...
    <div class="about-wrapper" id="about">
        <div class="about">
            <div class="about-header w-100 py-10 max-w-[46rem]">
                ...
                <h1 class="text-[36px] leading-tight text-zinc-900 font-semibold dark:text-white">AGRICONNECT: Solusi
                    Terbaik Untuk Masa Depan dan Teknologi Pertanian Indonesia</h1>
            </div>
