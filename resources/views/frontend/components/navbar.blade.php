<nav class="w-full fixed bg-white/80 dark:bg-ireng/30 backdrop-blur-md transition-colors border-b border-gray-200 dark:border-gray-700" style="z-index: 10000">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <!-- Middle buttons including TANI AI -->
            <div class="hidden md:flex flex-grow justify-center">
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('contact') }}" class="text-accent decoration-clone font-bold dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium {{ $active == 'contact' ? 'text-accent' : '' }}">Daftar jadi petani</a>
                </div>
            </div>

            <!-- Right side buttons (Jadi Petani and Profile/Login) -->
            <div class="flex items-center">
                <div class="flex items-center space-x-4">
                    <!-- Jadi Petani button -->
                    <a href="{{ route('tani') }}" class="text-white bg-accent hover:bg-accent-dark px-4 py-2 rounded-md text-sm font-medium {{ $active == 'tani-ai' ? 'ring-2 ring-green-400 dark:ring-green-300' : '' }}">
                        TANI AI
                    </a>
                    ...
                    <div class="profile relative">
                        ...
                        <div id="profile-menu" class="dropdown-menu mt-6 bg-white/30 dark:bg-ireng/80 border dark:border-zinc-600 backdrop-blur-2xl absolute hidden duration-300 opacity-0 transition-all du right-3 py-2 rounded-lg">
