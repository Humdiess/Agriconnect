        ...
        <div class="max-w-md w-full mx-auto">
            ...
            <form action="/sign-up" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Full Name -->
                    <div class="relative">
                        <label for="name" class="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Nama Lengkap</label>
                    ...
                    <!-- Username -->
                    <div class="relative">
                        <label for="username" class="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Nama Pengguna</label>
                ...
                <div class="relative">
                    <label for="email" class="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Email</label>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <!-- Confirm Password -->
                    <div class="relative">
                        <label for="password_confirmation" class="block text-sm lg:text-base font-medium text-gray-700 dark:text-gray-300 mb-2">Konfirmasi Kata Sandi</label>
