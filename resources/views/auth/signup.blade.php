    ...
    <div class="signup-left w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
        <div class="max-w-md w-full mx-auto">
            ...
            <div class="mb-6 flex items-center">
                <h1 class="text-xl lg:text-3xl font-semibold border-r-2 pr-3">Daftar</h1>
            ...
            <form action="/sign-up" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Full Name -->
                    <div class="relative">
                        <label for="name" class="block text-sm lg:text-base font-medium text-gray-700 mb-2">Nama Lengkap</label>
                        <input type="text" name="name" value="{{ old('name') }}" required
                            placeholder="Masukkan nama lengkap"
                            class="w-full px-4 py-3 rounded-lg bg-gray-100 @error('name') bg-red-100 @enderror focus:border-black focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ease-in-out">
                        @error('name')
                    ...
                    <!-- Username -->
                    <div class="relative">
                        <label for="username" class="block text-sm lg:text-base font-medium text-gray-700 mb-2">Nama Pengguna</label>
                        <input type="text" name="username" value="{{ old('username') }}" required
                            placeholder="Masukkan nama pengguna"
                            class="w-full px-4 py-3 rounded-lg bg-gray-100 @error('username') bg-red-100 @enderror focus:border-black focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ease-in-out">
                        @error('username')
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required
                        ...
                        class="w-full px-4 py-3 rounded-lg bg-gray-100 @error('email') bg-red-100 @enderror focus:border-black focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ease-in-out">
                    @error('email')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="password" name="password" required
                            ...
                            class="w-full px-4 py-3 rounded-lg bg-gray-100 @error('password') bg-red-100 @enderror focus:border-black focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ease-in-out">
                        @error('password')
                    ...
                    <!-- Confirm Password -->
                    <div class="relative">
                        <label for="password_confirmation" class="block text-sm lg:text-base font-medium text-gray-700 mb-2">Konfirmasi Kata Sandi</label>
                        <input type="password" id="password_confirmation" name="password_confirmation" required
                            placeholder="Konfirmasi kata sandi"
                            class="w-full px-4 py-3 rounded-lg bg-gray-100 @error('password_confirmation') bg-red-100 @enderror focus:border-black focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-200 ease-in-out">
