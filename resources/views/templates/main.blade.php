...
<div class="flex w-full bg-white h-screen dark:bg-ireng">
    ...
    <aside id="menu-mobile"
        ...
        <div class="flex-grow mt-8 lg:mt-0">
            ...
            <nav class="my-6 px-2">
                <a href="{{ url('/') }}"
                    class="flex items-center px-4 py-3 rounded-lg mb-2 {{ $active == 'home' ? 'text-white bg-accent dark:bg-zinc-800 dark:text-white' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-zinc-800' }} transition-colors duration-200">
        ...
        <div class="p-4 border-t dark:border-zinc-800">
            <div class="relative">
                ...
                <div id="profile-dropdown"
                    ...
                    <!-- Theme Toggle -->
                    <div
                        class="px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-zinc-700 transition-colors duration-200">
                        <div class="flex justify-between items-center">
                            <span>Dark Mode</span>
                            <label class="switch relative inline-block w-10 h-6">
                                <input type="checkbox" id="theme-toggle" class="theme-toggle sr-only">
                                <span
                                    class="slider absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-gray-300 dark:bg-gray-600 rounded-full transition-colors duration-200 before:absolute before:h-4 before:w-4 before:left-1 before:bottom-1 before:bg-white before:rounded-full before:transition-transform before:duration-200 before:ease-in-out"></span>
                            </label>
                        </div>
                    </div>
                </div>
