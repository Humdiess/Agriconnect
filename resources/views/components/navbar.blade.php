<section class="navbar justify-between py-6 px-16 items-center z-50 hidden md:flex">
    ...
    <div class="flex items-center space-x-4">
        <a class="px-6 py-2 border border-accent text-accent text-sm rounded-md transition-colors duration-300 hover:bg-accent hover:text-white" href="/login">
            Sign In
        </a>
        <a class="bg-accent px-6 py-2 text-white text-sm rounded-md transition-colors duration-300 hover:bg-accent-dark" href="/sign-up">
            Sign Up
        </a>
    </div>
    @endauth
