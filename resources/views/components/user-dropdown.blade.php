...
<button @click="dropdownOpen=true" class="inline-flex items-center justify-center text-sm font-medium transition-colors border rounded-full text-neutral-700 hover:bg-neutral-100  focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
...
<div x-show="dropdownOpen"
    ...
    class="absolute top-0 z-50 w-56 mt-12 -translate-x-1/2 left-2"
    x-cloak>
    <div class="p-1 mt-1 bg-white dark:bg-ireng/75 backdrop-blur-md border rounded-md shadow-md dark:border-zinc-700 text-neutral-700 dark:text-white">
